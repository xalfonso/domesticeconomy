          ...
          <div id="subview">
            ...
            */
            if(isset($_REQUEST['enviar']))  #Aqu� verifico si la variable del boton existe, para en ese caso procesarlo
            {
            	...
            	if(empty($nombre)==False && empty($descrip)==False && empty($saldo)==False && empty($fecha)==False && empty($tipo)==False)
            	{
            	   ...
            	   */
					...
					$tipoIngreso = new TipoIngreso("","",$tipo);
					$nuevoIngreso = new Ingreso($nombre,$descrip,$date,$saldo,$tipoIngreso);
               ...
               //Esta es una forma de utilizar el patron de dise�o 'Composite view'
		       require('subview_insertIngreso.php');
